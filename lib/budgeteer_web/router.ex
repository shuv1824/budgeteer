defmodule BudgeteerWeb.Router do
  ...
  scope "/", BudgeteerWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BudgeteerWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BudgeteerWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BudgeteerWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BudgeteerWeb do
    ...
    live_session :current_user,
      on_mount: [{BudgeteerWeb.UserAuth, :mount_current_user}] do
